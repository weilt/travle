...
import com.hx.core.pay.wxpay.error.WxErrorException;
import com.hx.core.pay.wxpay.util.BeanUtils;
...
import com.hx.core.pay.wxpay.xml.XStreamInitializer;
...
public abstract class BaseWxPayRequest implements Serializable {
  ...
  public void checkAndSign(WxPayConfig config) throws WxPayException {
    ...
    if (StringUtils.isBlank(getSignType())) {
      ...
      if (!WxPayConstants.SignType.ALL_SIGN_TYPES.contains(this.getSignType())) {
