...
//        },
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
				...
				html += '<a onclick="order_details('+rowData.order_id+',\'bureau/order/details\',\'订单详情\')" href="javascrip:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>订单详情</div></a>';
